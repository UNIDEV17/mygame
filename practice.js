                        ...
                        function gamestate() {
                            ...
                            setInterval(() => {
                                if (gamestatecrrent === 1) {
                                  ...
                                  levelresults.innerHTML = `Level: ${currentLevelIndex}`;
                                  playerpoints.innerHTML = `Player HeartPoints: ${player1.health}`;
                                    oj.innerHTML = parser(levels[currentLevelIndex], player1.xpos, player1.ypos, enmey.xpos, enmey.ypos);
                                }
                            }, 100);
